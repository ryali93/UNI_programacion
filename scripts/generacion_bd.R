...
cn = raster("raster/cn_area_min.tif")
area = shapefile("shp/gpo_area.shp")
...
dem_clip = raster("raster/dem_area_17s.tif")
p_resamp = Resamplear(p_area, dem_clip)
...
pp_mean_month(1, "raster/q_area_01_min.tif")
pp_mean_month(2, "raster/q_area_02_min.tif")
pp_mean_month(3, "raster/q_area_03_min.tif")
pp_mean_month(4, "raster/q_area_04_min.tif")
pp_mean_month(5, "raster/q_area_05_min.tif")
pp_mean_month(6, "raster/q_area_06_min.tif")
pp_mean_month(7, "raster/q_area_07_min.tif")
pp_mean_month(8, "raster/q_area_08_min.tif")
pp_mean_month(9, "raster/q_area_09_min.tif")
pp_mean_month(10, "raster/q_area_10_min.tif")
pp_mean_month(11, "raster/q_area_11_min.tif")
pp_mean_month(0, "raster/q_area_12_min.tif")
...
writeRaster(p_resamp[[1]], "raster/pisco_tmp.tif")
